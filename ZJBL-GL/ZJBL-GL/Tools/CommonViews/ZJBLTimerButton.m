...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.layer.borderColor = [UIColor colorWithHexCode:@"#f0f0f0"].CGColor;
...
- (void)refreshButtonView{
    [self setBackgroundImage:[self imageWithColor:[UIColor whiteColor] andSize:self.frame.size] forState:UIControlStateNormal];
